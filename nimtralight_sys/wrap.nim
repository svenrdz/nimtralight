...
type
  ...
  JSGlobalContextRef* = ptr OpaqueJSContext ## ```
                                            ...
                                            ## ```
  JSStringRef* = ptr OpaqueJSString ## ```
  ...
  JSChar* = ULChar16 ## ```
                     ...
                     ##    architecture.
                     ## ```
  ULChar16* {.incompleteStruct.} = cushort
  ...
  ULChangeTitleCallback* = proc (user_data: pointer; caller: ULView;
                                 title: ULString) {.cdecl.}
  ULChangeURLCallback* = proc (user_data: pointer; caller: ULView; url: ULString) {.
      cdecl.}
  ULChangeTooltipCallback* = proc (user_data: pointer; caller: ULView;
                                   tooltip: ULString) {.cdecl.}
  ...
  ULAddConsoleMessageCallback* = proc (user_data: pointer; caller: ULView;
                                       ...
                                       level: ULMessageLevel; message: ULString;
                                       line_number: cuint; column_number: cuint;
                                       source_id: ULString) {.cdecl.}
  ULCreateChildViewCallback* = proc (user_data: pointer; caller: ULView;
                                     opener_url: ULString; target_url: ULString;
                                     is_popup: bool; popup_rect: ULIntRect): ULView {.
      cdecl.}
  ...
  ULFailLoadingCallback* = proc (user_data: pointer; caller: ULView;
                                 frame_id: culonglong; is_main_frame: bool;
                                 url: ULString; description: ULString;
                                 error_domain: ULString; error_code: cint) {.
      cdecl.}
  ULWindowObjectReadyCallback* = proc (user_data: pointer; caller: ULView;
                                       frame_id: culonglong;
                                       is_main_frame: bool; url: ULString) {.
      cdecl.}
  ...
  ULFileHandle* = cint
  ULFileSystemFileExistsCallback* = proc (path: ULString): bool {.cdecl.}
  ULFileSystemGetFileSizeCallback* = proc (handle: ULFileHandle;
      result: ptr clonglong): bool {.cdecl.}
  ULFileSystemGetFileMimeTypeCallback* = proc (path: ULString; result: ULString): bool {.
      cdecl.}
  ULFileSystemOpenFileCallback* = proc (path: ULString; open_for_writing: bool): ULFileHandle {.
      cdecl.}
  ...
  ULLoggerLogMessageCallback* = proc (log_level: ULLogLevel; message: ULString) {.
      cdecl.}
  ...
  ULClipboardReadPlainTextCallback* = proc (result: ULString) {.cdecl.}
  ULClipboardWritePlainTextCallback* = proc (text: ULString) {.cdecl.}
...
proc destroyConfig*(config: ULConfig) {.importc: "ulDestroyConfig", cdecl.}
  ## ```
                                                                           ...
                                                                           ##     /
                                                                           ## ```
proc setResourcePath*(config: ULConfig; resource_path: ULString) {.
  ...
  ## ```
                                               ...
                                               ##     /
                                               ## ```
proc setCachePath*(config: ULConfig; cache_path: ULString) {.
...
proc setFontGamma*(config: ULConfig; font_gamma: cdouble) {.
  ...
  ## ```
                                            ...
                                            ##     /
                                            ## ```
proc setFontFamilyStandard*(config: ULConfig; font_name: ULString) {.
  ...
  ## ```
                                                     ...
                                                     ##     /
                                                     ## ```
proc setFontFamilyFixed*(config: ULConfig; font_name: ULString) {.
  ...
  ## ```
                                                  ...
                                                  ##     /
                                                  ## ```
proc setFontFamilySerif*(config: ULConfig; font_name: ULString) {.
  ...
  ## ```
                                                  ...
                                                  ##     /
                                                  ## ```
proc setFontFamilySansSerif*(config: ULConfig; font_name: ULString) {.
  ...
  ## ```
                                                      ...
                                                      ##     /
                                                      ## ```
proc setUserAgent*(config: ULConfig; agent_string: ULString) {.
  ...
  ## ```
                                            ...
                                            ##     /
                                            ## ```
proc setUserStylesheet*(config: ULConfig; css_string: ULString) {.
...
proc logMemoryUsage*(renderer: ULRenderer) {.importc: "ulLogMemoryUsage", cdecl.}
  ## ```
                                                                                 ...
                                                                                 ##     /
                                                                                 ## ```
proc createSession*(renderer: ULRenderer; is_persistent: bool; name: ULString): ULSession {.
...
proc isPersistent*(session: ULSession): bool {.importc: "ulSessionIsPersistent",
  ...
  ## ```
           ...
           ##     /
           ## ```
proc getName*(session: ULSession): ULString {.importc: "ulSessionGetName", cdecl.}
  ## ```
                                                                                  ##   /
...
proc getId*(session: ULSession): culonglong {.importc: "ulSessionGetId", cdecl.}
  ## ```
                                                                                ...
                                                                                ##     /
                                                                                ## ```
proc getDiskPath*(session: ULSession): ULString {.
...
proc destroyView*(view: ULView) {.importc: "ulDestroyView", cdecl.}
  ## ```
                                                                   ...
                                                                   ##     /
                                                                   ## ```
proc getURL*(view: ULView): ULString {.importc: "ulViewGetURL", cdecl.}
  ## ```
                                                                       ##   /
                                                                       ##     / Get current URL.
                                                                       ##     /
                                                                       ...
                                                                       ##     /
                                                                       ## ```
proc getTitle*(view: ULView): ULString {.importc: "ulViewGetTitle", cdecl.}
  ## ```
                                                                           ##   /
                                                                           ##     / Get current title.
                                                                           ##     /
...
proc getSurface*(view: ULView): ULSurface {.importc: "ulViewGetSurface", cdecl.}
  ## ```
                                                                                ...
                                                                                ##     /
                                                                                ## ```
proc loadHTML*(view: ULView; html_string: ULString) {.importc: "ulViewLoadHTML",
    cdecl.}
  ## ```
           ##   /
           ...
           ##     /
           ## ```
proc loadURL*(view: ULView; url_string: ULString) {.importc: "ulViewLoadURL",
    cdecl.}
  ## ```
           ##   /
...
proc unlockJSContext*(view: ULView) {.importc: "ulViewUnlockJSContext", cdecl.}
  ## ```
                                                                               ...
                                                                               ##     /
                                                                               ## ```
proc evaluateScript*(view: ULView; js_string: ULString; exception: ptr ULString): ULString {.
...
proc createInspectorView*(view: ULView): ULView {.
  ...
  ## ```
                                                 ...
                                                 ##     /
                                                 ## ```
proc createString*(str: cstring): ULString {.importc: "ulCreateString", cdecl.}
  ## ```
                                                                               ##   ***************************************************************************
                                                                               ##    String
                                                                               ##   **************************************************************************
                                                                               ...
                                                                               ##     /
                                                                               ## ```
proc createStringUTF8*(str: cstring; len: uint): ULString {.
  ...
  ## ```
                                          ...
                                          ##     /
                                          ## ```
proc createStringUTF16*(str: ptr ULChar16; len: uint): ULString {.
  ...
  ## ```
                                           ...
                                           ##     /
                                           ## ```
proc createStringFromCopy*(str: ULString): ULString {.
  ...
  ## ```
                                              ...
                                              ##     /
                                              ## ```
proc destroyString*(str: ULString) {.importc: "ulDestroyString", cdecl.}
  ## ```
                                                                        ##   /
                                                                        ##     / Destroy string (you should destroy any strings you explicitly Create).
                                                                        ##     /
                                                                        ## ```
proc getData*(str: ULString): ptr ULChar16 {.importc: "ulStringGetData", cdecl.}
  ## ```
                                                                                ##   /
                                                                                ##     / Get internal UTF-16 buffer data.
                                                                                ##     /
                                                                                ## ```
proc getLength*(str: ULString): uint {.importc: "ulStringGetLength", cdecl.}
  ## ```
                                                                            ##   /
                                                                            ##     / Get length in UTF-16 characters.
                                                                            ##     /
                                                                            ## ```
proc isEmpty*(str: ULString): bool {.importc: "ulStringIsEmpty", cdecl.}
  ## ```
                                                                        ##   /
                                                                        ##     / Whether this string is empty or not.
                                                                        ##     /
                                                                        ## ```
proc assignString*(str: ULString; new_str: ULString) {.
  ...
  ## ```
                                            ...
                                            ##     /
                                            ## ```
proc assignCString*(str: ULString; c_str: cstring) {.
...
proc createKeyEvent*(`type`: ULKeyEventType; modifiers: cuint;
                     ...
                     text: ULString; unmodified_text: ULString; is_keypad: bool;
                     is_auto_repeat: bool; is_system_key: bool): ULKeyEvent {.
...
proc destroySettings*(settings: ULSettings) {.importc: "ulDestroySettings",
  ...
  ## ```
           ...
           ##     /
           ## ```
proc setDeveloperName*(settings: ULSettings; name: ULString) {.
  ...
  ## ```
                                                  ...
                                                  ##     /
                                                  ## ```
proc setAppName*(settings: ULSettings; name: ULString) {.
  ...
  ## ```
                                            ...
                                            ##     /
                                            ## ```
proc setFileSystemPath*(settings: ULSettings; path: ULString) {.
...
proc enablePlatformFontLoader*() {.importc: "ulEnablePlatformFontLoader", cdecl.}
  ## ```
                                                                                 ...
                                                                                 ##     /
                                                                                 ## ```
proc enablePlatformFileSystem*(base_dir: ULString) {.
  ...
  ## ```
                                                  ...
                                                  ##     /
                                                  ## ```
proc enableDefaultLogger*(log_path: ULString) {.
